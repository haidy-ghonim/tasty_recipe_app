...
import 'detailspage/details_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<FreshRecipesProvider>(
        builder: (ctx, freshRecipesProvider, _) => freshRecipesProvider
                    .resultFilter ==
                null
            ? const CircularProgressIndicator()
            : (freshRecipesProvider.resultFilter?.isEmpty ?? false)
                ? const Text('No Data Found')
                : FlexibleGridView(
                    children: freshRecipesProvider.resultFilter!.toList()
                        .map(
                          (e) => GestureDetector(
                            onTap: () {
