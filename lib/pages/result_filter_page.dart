...
class _ResultFilterPageState extends State<ResultFilterPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<void>(
        future: Provider.of<FreshRecipesProvider>(context, listen: false)
            .getFilteredResult(),
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.done) {
            return widget.resultFilter != null
                ? ResultPage(recipeList: widget.resultFilter!)
                : const Center(
  ...
  ResultPage({required List<RecipeModel> recipeList}) {}
}
