...
class AllRecipesPage extends StatefulWidget {
  final List<RecipeModel> seeAll;
  const AllRecipesPage({super.key, required this.seeAll});
  @override
...
class _AllRecipesPageState extends State<AllRecipesPage> {
  ...
  void all() async {
    await Provider.of<FreshRecipesProvider>(context, listen: false).getAllRecipes();
